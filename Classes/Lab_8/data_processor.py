"""
Module defining the DataProcessor class for processing and visualizing iris dataset.
"""
...
class DataProcessor:
    """
    DataProcessor class for processing and visualizing iris dataset.
    """
    ...
    def __init__(self):
        ...
        relative_file_path = os.path.join(current_file_directory, '../../../SPL_Labs/BLL/Lab8/iris.csv')

        # Load the data from the CSV file into a pandas DataFrame
        self.df = pd.read_csv(relative_file_path)

        # Define the output directory for saving visualizations
        self.output_directory = os.path.join('../../../SPL_Labs/BLL', 'Data')

    def explore_data(self):
        """
        Method to explore the data by printing descriptive statistics.
        """
    ...
    def visualize_data(self, save=False):
        """
        Method to visualize the data through various plots and charts.
        """
